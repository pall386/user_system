...
?>
		...
		<div class="row justify-content-center">
				<div class="col-lg-10 ">
				<div class="card rounded-0 mt-3 border">
								...
								<div class="card-deck">
									<div class="card border-primary">
										...
										<div class="card-body">
											...
											<p class="card-text p-2 m-1 rounded" style="border:1px solid #0275d8;"><b> Regsitered On : </b><?= $reg_on;?></p>
									...
									<div class="card border-primary align-self-center">
										<?php if(!$cphoto):?>
											<img src="assets/img/user.png" class="img-thumbnail img-fluid" width="408px">
											<?php else:?>
							...
							<div class="tab-pane container fade" id="changePass">
								...
								<div class="card-deck">
									...
									<div class="card border-success align-self-center">
										<img src="assets/img/pass.png" class="img-thumbnail img-fluid" width="405px">
									</div>
								</div>								
							</div>
